...
/**
 * Extract Discord snowflake (ID) from raw input.
 * Supports plain IDs and mentions like `<:name:id>` / `<a:name:id>`.
 */
export const extractSnowflake = (input: string): string | null => {
